package net.flandre923.minehelper.block;

import net.flandre923.minehelper.MineHelper;
import net.flandre923.minehelper.block.custom.MyAnvilBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS =
            DeferredRegister.create(BuiltInRegistries.BLOCK, MineHelper.MODID);
